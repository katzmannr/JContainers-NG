...
<img src="logo-nexus.png?raw=true" height="256">
...
Please have a look at [LICENSES](LICENSES) folder and the accompanying [licenses.txt](LICENSES/licenses.txt) file for all project licenses. 
