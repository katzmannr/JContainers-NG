...
namespace collections
{
    ...
    public:
        ...
        using ref = object_stack_ref_template<T>;
        using cref = object_stack_ref_template<const T>;
    ...
    template<class mRealType, class mContainerType>
    class basic_map_collection : public collection_base< mRealType > {
    public:
        using container_type = mContainerType;
        using value_type = typename container_type::value_type;
        using key_type = typename mContainerType::key_type;
    ...
    public:
        ...
        const item* u_get(const Key& key) const {
            auto itr = mRealType::_find(cnt, key);
        ...
        template<class Key>
        const_iterator u_find_iterator(const Key& k) const { return mRealType::_find(cnt, k); }
        ...
        bool u_erase(const Key& key) {
            typename container_type::iterator itr = mRealType::_find(cnt, key);
